#!/usr/bin/python
from ebuild_generator.gen_packages import generate_installers
from ebuild_generator.overlay_instance import ros_overlay
import shutil
import sys
import os
...
for distro in selected_targets:
    distro_installers, distro_broken, distro_changes = generate_installers(distro, overlay, preserve_existing)
